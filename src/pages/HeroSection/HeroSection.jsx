  ...
  return (
    <>
      <div className="hero-section__background">
        <div className="hero-section__background-hexagonstraight hero-section__background-element hexagon">
          <HexagonStraight />
        </div>
        <div className="hero-section__background-circle hero-section__background-element circle">
          <Circle />
        </div>
        <div className="hero-section__background-dot hero-section__background-element dot">
          <Dot />
        </div>
        <div className="hero-section__background-hexagonbenzene hero-section__background-element hexabenzene">
          <HexagonBenzene />
        </div>
        <div className="hero-section__background-triangle hero-section__background-element triangle">
          <Triangle />
        </div>
        <div className="hero-section__background-benzene hero-section__background-element benzene">
          <Benzene />
        </div>
        <div className="hero-section__background-tiltedtriangle hero-section__background-element triangle">
          <Triangle />
        </div>
      ...
      <div className="hero-section">
        ...
        <div className="heading-4 hero-section__heading-4 u-color-primary">
          <span>HELLO</span>
        </div>
